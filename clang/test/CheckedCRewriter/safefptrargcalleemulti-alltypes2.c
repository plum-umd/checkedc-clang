...
function safely (without unsafe casting)*//*For robustness, this test is identical to safefptrargprotocallee-alltypes.c and safefptrargcallee-alltypes.c except in that
