...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotoboth-alltypes.c and unsafefptrargboth-alltypes.c except in that
