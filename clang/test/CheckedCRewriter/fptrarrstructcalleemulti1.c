...
of a struct that interact with each other*//*For robustness, this test is identical to fptrarrstructprotocallee.c and fptrarrstructcallee.c except in that
