// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrscallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrscallermulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrscallermulti-alltypes1.checked2.c %S/unsafefptrscallermulti-alltypes2.checked2.c
