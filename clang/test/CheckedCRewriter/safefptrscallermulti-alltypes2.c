// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrscallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrscallermulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrscallermulti-alltypes1.checked2.c %S/safefptrscallermulti-alltypes2.checked2.c
