// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrssafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrssafemulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrssafemulti-alltypes1.checked.c %S/safefptrssafemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to safefptrsprotosafe-alltypes.c and safefptrssafe-alltypes.c except in that
