...
and then using that pointer for computations*//*For robustness, this test is identical to fptrsafeprotocallee-alltypes.c and fptrsafecallee-alltypes.c except in that
