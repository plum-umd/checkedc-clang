...
/*For robustness, this test is identical to safefptrssafe.c except in that
...
//CHECK: _Ptr<_Ptr<int> (_Ptr<int> )> sus(int (*x)(int), _Ptr<int (int )> y);
...
return z; }
//CHECK: _Ptr<_Ptr<int> (_Ptr<int> )> foo(void) {
...
return z; }
//CHECK: _Ptr<_Ptr<int> (_Ptr<int> )> bar(void) {
//CHECK:         int (*x)(int) = add1; 
