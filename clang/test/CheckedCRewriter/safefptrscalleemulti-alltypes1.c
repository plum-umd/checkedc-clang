// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrscalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrscalleemulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrscalleemulti-alltypes1.checked.c %S/safefptrscalleemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to safefptrsprotocallee-alltypes.c and safefptrscallee-alltypes.c except in that
...
//CHECK: int * (*sus(int (*) (int), int (*) (int))) (int *);
