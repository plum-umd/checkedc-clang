...
of a struct that interact with each other*//*For robustness, this test is identical to fptrarrstructprotocaller.c and fptrarrstructcaller.c except in that
