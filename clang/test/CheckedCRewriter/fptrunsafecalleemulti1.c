...
unsafely via cast and using that pointer for computations*//*For robustness, this test is identical to fptrunsafeprotocallee.c and fptrunsafecallee.c except in that
