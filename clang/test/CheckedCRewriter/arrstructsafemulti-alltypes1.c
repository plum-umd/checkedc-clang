...
traverse through the values of a struct*//*For robustness, this test is identical to arrstructprotosafe-alltypes.c and arrstructsafe-alltypes.c except in that
