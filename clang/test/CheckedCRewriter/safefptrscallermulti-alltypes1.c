// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrscallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrscallermulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrscallermulti-alltypes1.checked.c %S/safefptrscallermulti-alltypes2.checked.c
...
/*For robustness, this test is identical to safefptrsprotocaller-alltypes.c and safefptrscaller-alltypes.c except in that
