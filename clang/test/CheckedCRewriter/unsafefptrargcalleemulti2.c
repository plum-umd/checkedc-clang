// RUN: cconv-standalone -base-dir=%S -output-postfix=checked2 %s %S/unsafefptrargcalleemulti1.c
...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotocallee.c and unsafefptrargcallee.c except in that
