// RUN: cconv-standalone -base-dir=%S -output-postfix=checked2 %s %S/unsafefptrargbothmulti1.c
...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotoboth.c and unsafefptrargboth.c except in that
