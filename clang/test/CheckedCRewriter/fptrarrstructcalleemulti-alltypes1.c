...
of a struct that interact with each other*//*For robustness, this test is identical to fptrarrstructprotocallee-alltypes.c and fptrarrstructcallee-alltypes.c except in that
