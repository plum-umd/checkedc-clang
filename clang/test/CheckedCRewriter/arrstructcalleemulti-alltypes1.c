...
traverse through the values of a struct*//*For robustness, this test is identical to arrstructprotocallee-alltypes.c and arrstructcallee-alltypes.c except in that
