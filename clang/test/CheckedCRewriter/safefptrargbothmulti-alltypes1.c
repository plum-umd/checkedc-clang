...
function safely (without unsafe casting)*//*For robustness, this test is identical to safefptrargprotoboth-alltypes.c and safefptrargboth-alltypes.c except in that
