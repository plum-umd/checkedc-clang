...
traverse through the values of a struct*//*For robustness, this test is identical to arrstructprotocaller-alltypes.c and arrstructcaller-alltypes.c except in that
