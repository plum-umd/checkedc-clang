...
unsafely via cast and using that pointer for computations*//*For robustness, this test is identical to fptrunsafeprotocaller-alltypes.c and fptrunsafecaller-alltypes.c except in that
