...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotocaller-alltypes.c and unsafefptrargcaller-alltypes.c except in that
