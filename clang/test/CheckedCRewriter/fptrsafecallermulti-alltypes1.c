...
and then using that pointer for computations*//*For robustness, this test is identical to fptrsafeprotocaller-alltypes.c and fptrsafecaller-alltypes.c except in that
