...
and then using that pointer for computations*//*For robustness, this test is identical to fptrsafeprotoboth-alltypes.c and fptrsafeboth-alltypes.c except in that
