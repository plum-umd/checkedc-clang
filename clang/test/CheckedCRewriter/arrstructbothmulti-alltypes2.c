...
traverse through the values of a struct*//*For robustness, this test is identical to arrstructprotoboth-alltypes.c and arrstructboth-alltypes.c except in that
