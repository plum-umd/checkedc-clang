// RUN: cconv-standalone -base-dir=%S -output-postfix=checked2 %s %S/unsafefptrargcallermulti1.c
...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotocaller.c and unsafefptrargcaller.c except in that
