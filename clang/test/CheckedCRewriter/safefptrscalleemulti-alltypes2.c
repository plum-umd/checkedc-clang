// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrscalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrscalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrscalleemulti-alltypes1.checked2.c %S/safefptrscalleemulti-alltypes2.checked2.c
