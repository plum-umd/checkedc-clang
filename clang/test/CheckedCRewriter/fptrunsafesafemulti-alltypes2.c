...
unsafely via cast and using that pointer for computations*//*For robustness, this test is identical to fptrunsafeprotosafe-alltypes.c and fptrunsafesafe-alltypes.c except in that
