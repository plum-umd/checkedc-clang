...
/*In particular, this file tests: having a pointer to a pointer*//*For robustness, this test is identical to ptrTOptrprotocaller-alltypes.c and ptrTOptrcaller-alltypes.c except in that
