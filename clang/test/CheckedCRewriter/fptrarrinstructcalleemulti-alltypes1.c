...
of function pointers in a struct*//*For robustness, this test is identical to fptrarrinstructprotocallee-alltypes.c and fptrarrinstructcallee-alltypes.c except in that
