// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrssafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrssafemulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrssafemulti-alltypes1.checked2.c %S/safefptrssafemulti-alltypes2.checked2.c
