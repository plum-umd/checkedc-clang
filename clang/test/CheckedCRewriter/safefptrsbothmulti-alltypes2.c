// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrsbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrsbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrsbothmulti-alltypes1.checked2.c %S/safefptrsbothmulti-alltypes2.checked2.c
