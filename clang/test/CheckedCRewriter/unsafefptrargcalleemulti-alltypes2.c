...
function unsafely (by casting it unsafely)*//*For robustness, this test is identical to unsafefptrargprotocallee-alltypes.c and unsafefptrargcallee-alltypes.c except in that
