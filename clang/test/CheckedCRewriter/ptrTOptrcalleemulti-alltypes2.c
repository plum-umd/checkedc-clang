...
/*In particular, this file tests: having a pointer to a pointer*//*For robustness, this test is identical to ptrTOptrprotocallee-alltypes.c and ptrTOptrcallee-alltypes.c except in that
