...
of a struct that interact with each other*//*For robustness, this test is identical to fptrarrstructprotocaller-alltypes.c and fptrarrstructcaller-alltypes.c except in that
