// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrsbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrsbothmulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrsbothmulti-alltypes1.checked.c %S/safefptrsbothmulti-alltypes2.checked.c
...
/*For robustness, this test is identical to safefptrsprotoboth-alltypes.c and safefptrsboth-alltypes.c except in that
