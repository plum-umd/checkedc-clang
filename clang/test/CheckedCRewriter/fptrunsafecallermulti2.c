...
unsafely via cast and using that pointer for computations*//*For robustness, this test is identical to fptrunsafeprotocaller.c and fptrunsafecaller.c except in that
