...
of a struct that interact with each other*//*For robustness, this test is identical to fptrarrstructprotosafe-alltypes.c and fptrarrstructsafe-alltypes.c except in that
