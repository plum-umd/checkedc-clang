// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/unsafefptrsbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrsbothmulti-alltypes1.checked.c %s
//RUN: rm %S/unsafefptrsbothmulti-alltypes1.checked.c %S/unsafefptrsbothmulti-alltypes2.checked.c
