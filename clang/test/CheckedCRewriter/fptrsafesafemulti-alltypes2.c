...
and then using that pointer for computations*//*For robustness, this test is identical to fptrsafeprotosafe-alltypes.c and fptrsafesafe-alltypes.c except in that
