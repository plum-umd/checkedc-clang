// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrssafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrssafemulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrssafemulti-alltypes1.checked2.c %S/unsafefptrssafemulti-alltypes2.checked2.c
