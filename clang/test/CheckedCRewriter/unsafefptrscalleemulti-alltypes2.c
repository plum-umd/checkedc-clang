// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrscalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrscalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrscalleemulti-alltypes1.checked2.c %S/unsafefptrscalleemulti-alltypes2.checked2.c
